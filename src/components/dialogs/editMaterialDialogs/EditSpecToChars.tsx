...
import { addSpecToCharAtom, deleteSpecToCharAtom, materialListAtom } from "../../../atoms/materials/chars"
...
export default function EditSpecToChars() {
    ...
    return <EditContainer>
        <div>
            ...
            <hr />
            <TableData heads={heads} content={contents} onSelectKey={key => { setSelectedCharId(key as number) }} />
        </div>
