...
export default function PropertiesBar() {
    ...
    return <div className="properties-bar" onClick={(e) => { e.stopPropagation() }}> 
        ...
        <PropertyGrid>
            ...
            <ComboBox<number> title="Цвет/Рисунок:" value={materialId} altValue={materialId === 0 ? "комби" : undefined} items={materials} displayValue={value => chars.get(value)?.name} disabled={!fasad} onChange={value => { setMaterialId(value) }}  disableTyping={true} styles={{minWidth: "50px"}}/>
